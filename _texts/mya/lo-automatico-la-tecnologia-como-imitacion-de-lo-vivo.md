...
permalink: /personal/mito-y-automata/lo-automatico-la-tecnologia-como-imitacion-de-lo-vivo
position: 3
---
...
En este texto quiero reflexionar sobre la relación entre lo vivo y lo automático, partiendo del concepto de mímesis, a la que dedicaré la primera parte. Después, haré un repaso sobre cómo se presenta históricamente esta relación en la tecnología, empezando por las versiones más primitivas de lo que, con ciertas licencias, podríamos considerar automático. Iré planteando algunas cuestiones que resultan de percibir el uso de estas tecnologías en distintos contextos culturales.
-->
...
Según Thomas R. Martin, la observación del cielo y el descubrimiento de patrones que podían estudiarse y predecirse tuvo un papel importante para el paso del mito al *logos* (de la explicación mítica a la explicación racional) que comenzó en la Grecia Antigua. La posibilidad de que el universo tuviera un orden permitió la concepción del *cosmos*, llamado así por una característica inteligibilidad y belleza (de ahí el término *cosmético*). 
